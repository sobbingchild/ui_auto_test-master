...
class QuickFileScripts(LoginBase):
    ...
    def test_01_remote_file(self):
        ...
        self.my_click(element=quick_excute_scripts.name_source_file)

        self.my_click(element=quick_excute_scripts.input_source_file_path_first)
        self.my_click(element=quick_excute_scripts.input_source_file_path_second)
        self.my_click(element=quick_excute_scripts.input_source_file_path_third)
        self.my_click(element=quick_excute_scripts.input_source_file)

        self.my_click(element=quick_excute_scripts.input_confirm_source_file)
