...
class AddService(seldom.TestCase):
    ...
    def test_03_add_API(self):
        ...
        time.sleep(2)
        self.Keys(xpath=page.node_api_handler_input).enter()
    ...
    def test_06_add_countersign_node(self):
        ...
        time.sleep(1)
        self.Keys(xpath=page.node_countersign_handler1).enter()
        self.type(xpath=page.node_countersign_handler2, text=settings.INPUT_USER2)
        time.sleep(1)
        self.Keys(xpath=page.node_countersign_handler2).enter()
        self.type(xpath=page.node_countersign_handler3, text=settings.INPUT_USER3)
        self.Keys(xpath=page.node_countersign_handler3).enter()
