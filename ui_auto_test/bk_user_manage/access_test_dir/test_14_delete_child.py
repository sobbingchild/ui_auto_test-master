...
class DeleteChild(seldom.TestCase):
    def test_01_switch(self):
        ...
        if self.get_text(xpath=user_organization.Department_Name) == user_organization.Department_Name_Input:
            ...
            print("切换组织失败")
    def test_02_delete_child(self):
        '''删除下级组织'''
        self.click(xpath=user_organization.Child_BeRename)
        self.click(xpath=user_organization.Department_Option)
        self.click(xpath=user_organization.Department_Delete)
