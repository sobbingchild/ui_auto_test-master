...
class NewLDAP(seldom.TestCase):
    ...
    def test_02_new_catalog(self):
        ...
        self.click(xpath=user_catalog.OpenLDAP_Catalog)
        ...
        self.type(xpath=user_catalog.LocalCatalog_Domain,text=settings.Name_5)
        print("目录名称为:"+user_catalog.LocalCatalogName)
        print("登录域为:"+settings.Name_5)
        print("基础设置填写完成")
