...
class Au_Audi_Bnt_Reject(seldom.TestCase):
    def test_01_cloud_api_permissions(self):
        ...
        # 搜索框搜索应用
        self.type(xpath=application_development.search_application, text="制品库")
        # 模拟enter键
    ...
    def test_02_au_audi_bnt_reject(self):
        '''拒绝申请权限'''
        # 点击云API
        ...
        # 全部拒绝
        self.click(xpath=cloud_api.all_reject)
        # 确定
