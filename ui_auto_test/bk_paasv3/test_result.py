...
from bk_paasv3.base_operate import BaseOperate
from bk_paasv3 import settings

base = BaseOperate()
with open('test_url.txt', 'w', encoding='utf-8') as txt:
    base.read_test_url()
    txt.write('测试环境为：' + settings.PAAS_URL + "\r\n")
...
bs = BeautifulSoup(open('./reports/paas_ui_auto_test.html', encoding='utf-8'), 'lxml')
